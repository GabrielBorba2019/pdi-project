...
class IngredientServiceTest {
    ...
    private IngredientTypeRepository ingredientTypeRepository = Mockito.mock(IngredientTypeRepository.class);
    private IngredientRepository ingredientRepository = Mockito.mock(IngredientRepository.class);

    private IngredientService service = new IngredientService(unitMeasureRepository, ingredientTypeRepository, ingredientRepository);
    ...
    void createIngredientsWithEmptyList() {
        RuntimeException exception = assertThrows(IngredientValidationException.class, () -> {
